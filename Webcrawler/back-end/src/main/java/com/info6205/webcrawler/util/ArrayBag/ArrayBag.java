package com.info6205.webcrawler.util.ArrayBag;
...
public final class ArrayBag<T> implements BagInterface<T> {
	...
	/**
	 * Creates a new pile with capacity double than previous pile
	 * 
	 */
	...
	/**
	 * Checks if size of the pile exceeds maximum allowed capacity and throws
